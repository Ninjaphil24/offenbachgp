...
<div class="myButton">
  ...
  <a href="2watchabc.php" class="active" >Alphabetically</a>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result = mysqli_query($con,"SELECT * FROM `applicants2` ORDER BY last_name LIMIT $offset, $total_records_per_page");
