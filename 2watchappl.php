...
<div class="myButton">
  ...
  <a href="2watchappl.php"  class="active" >Ranking by Applause</a>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result = mysqli_query($con,"SELECT * FROM `applicants2` ORDER BY like_count DESC LIMIT $offset, $total_records_per_page");
