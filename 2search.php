    ...
    <a href="http://spoiledeggs.eu5.org/" target="_blank" class="logo"> <img src="img/egglogo.png" alt=""> </a>
      ...
      <nav>
        <ul>
          ...
          <li><a href="2watch.php">2nd Round</a></li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <h4>Welcome to the singing competition where your vote counts! <br> <br>
                    1.  Click on a contestant from the list below. You can browse randomly or alphabetically and you can also browse by ranking or public's applause or jury's votes.<br> <br>
                    2.  Once on a contestant's page, click the video button and listen to their entry. <br> <br>
                    3.  Applaud!  Click the applause button as many times as you like to support the singer.  The 30 highest applause rankings will count as one juror's vote. <br> <br>
...
<ul>
  <?php
      if (isset($_GET['page_no']) && $_GET['page_no']!="") {
        ...
        $result_count = mysqli_query($con,"SELECT COUNT(*) As total_records FROM `applicants`");
      ...
      if (isset($_POST['submit-search'])) {
        ...
        $sql = "SELECT * FROM applicants2 WHERE (first_name LIKE '%$search%' OR last_name LIKE '%$search%' OR voice_type LIKE '%$search%') OR (first_name AND last_name LIKE '%$search%')";
        $result = mysqli_query($con, $sql);
        $queryResult = mysqli_num_rows($result);

        echo "<h5>There are ".$queryResult." results!</h5>";
        ...
        if ($queryResult > 0) {
          while ($row = mysqli_fetch_assoc($result)){
            ...
            Public's applause so far:&nbsp;".$row['like_count']." Claps!<p>
            <br> <br>
          </a><br></li>";
