        ...
        <div class="row m-0">
            <div class="col-lg-4 offset-lg-2">
                <div class="text-center pb-5">
                    ...
                    <span class="font-ubuntu text-white" style="background: black;">I already have <a href="2watch.php">Login</a></span>
                </div>
                ...
                <div class="d-flex justify-content-center">
                    <form action="register.php" method="post" enctype="multipart/form-data" id="reg-form">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <label for="agreement" class="form-check-label font-ubuntu text-white" style="background: black;">I have read and agree to the <a href="terms.html" target="_blank">terms and conditions</a>.(*) </label>
                        </div>
